 ...
 *
 * The {@link de.ks.standbein.i18n.Localized} class is your main entry point here.
 *
 * The {@link java.util.Locale#getDefault()} is always used as the current language.
 * Language can be changed via {@link de.ks.standbein.i18n.Localized#changeLocale(java.util.Locale)}
 *
 * With changing the language the event {@link de.ks.standbein.i18n.event.LanguageChangedEvent }
 ...
 *
 * Basic usage: {@link de.ks.standbein.i18n.Localized#get(String, Object...)}
